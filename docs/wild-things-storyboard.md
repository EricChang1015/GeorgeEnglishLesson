# Lesson 7 定稿分鏡 — *George and the Wild Parade*

**總頁數：19 頁**  
**狀態：** GATE 1 已簽核（2026-09-02）。視覺鎖見 [`wild-things-bible.md`](wild-things-bible.md)。

## 本稿賣點

- 用「拒退 → 三獸示威 → 對視 → 獲邀入島」建立不靠武力的完整馴服因果。
- 島段由原本 4 頁擴成 11 頁，George 真正當了一陣子溫柔又好笑的王。
- 兩頁 wild parade 加一頁王規、一頁延續遊戲，歡樂有變化而不重複。
- 冠變重、肚子叫、鳥燈暖光與家中香氣逐步推動 George 自願回家。

## 島上擴寫對照表（對照現行 12 頁）

| 現行頁／節拍 | 本稿頁 | 擴寫內容 | because → therefore |
|---|---:|---|---|
...
| Role key | 名字 | 劇情功能 | 鎖定外形 |
|---|---|---|---|
| `horn` | Horn | 最大、擋岸、先低頭，最後保管王冠 | 牛角、條紋身、獅鬃，約 George 3× 高 |
| `beak` | Beak | 用利爪示威、領遊行、獻藤冠 | 雞冠、黃羽、鳥嘴，約 George 2.2× 高 |
| `goat` | Goat | 溫和警告、認同王規、允許王離開 | 捲羊角、山羊鬍，約 George 2.6× 高 |

禁止電影官方名；禁止第四隻野獸。對白不使用 *I'll eat you up* 或 *let the wild rumpus start*。
...
**敘事功能：** 因為 George 玩得太野，所以追逐打擾 Sylvia，召來 Mummy。  
**翻頁鉤子：** Mummy 聽見木叉碰地的聲音，走向客廳。  
**圖上必見證據：** George 穿棕／卡其 T-rex 連身裝與頭套，室內赤腳或穿襪；木叉只舉在胸前；Sylvia 戴黑方框眼鏡、穿墨綠睡衣，笑鬧但不哭；LivingRoom 沙發與暖燈清楚可見。  
**在場：** george, sylvia  
**禁止：** 刺人、流血、Sylvia 大哭、Mike／Nibble、運動鞋、南瓜桶、L4 床。
...
**敘事功能：** 因為追逐沒有停，所以 Mummy 定下界線；George 回嘴，因此被取消晚餐並送回房。  
**翻頁鉤子：** George 抱著木叉氣沖沖走向房門。  
**圖上必見證據：** Mummy 戴細圓框眼鏡、穿藕粉睡衣，嚴厲但不恐怖並指向臥室；George 仍穿完整 T-rex 裝、握木叉、室內無鞋；Sylvia 的黑方框眼鏡與墨綠成套睡衣清楚。  
**在場：** george, mummy, sylvia  
**禁止：** 推搡、恐怖懲罰、換裝、室內穿鞋、Daddy 睡前朗讀構圖。
...
**敘事功能：** 因為 George 被送回房又拒絕晚餐，所以孤單與飢餓一起出現。  
**翻頁鉤子：** 當他把木叉放在床邊時，奶油牆上冒出一片綠葉。  
**圖上必見證據：** L4 RealBedroom 的米色軟墊床頭與木邊、奶油被、淡藍床單、床邊光鳥燈、床頭左側實牆、遠牆灰簾；George 穿完整 T-rex 裝赤腳坐床上；木叉放在床邊。  
**在場：** george  
**禁止：** 運動鞋、星形燈、檯燈、Mike／Nibble、脫頭套。
...
**敘事功能：** 因為 George 注意到第一片葉子，所以他看見藤蔓正把熟悉房間變成叢林。  
**翻頁鉤子：** 葉叢被推開，露出一面茶葉徽帆。  
**圖上必見證據：** 藤蔓沿奶油牆與米色床頭生長；床、淡藍床單、光鳥燈、灰簾仍可辨認；George 穿完整 T-rex 裝赤腳站在床上；木叉留在床邊。  
**在場：** george  
**禁止：** 房間完全消失、pillow cave、第二個 George、木叉隨身變武器。
...
**敘事功能：** 因為 George 看見帆，所以他找到 Billy o' Tea；因為他仍想逃離規矩，所以主動上船。  
**翻頁鉤子：** 船頭穿過灰簾般的葉幕，前方亮起海面。  
**圖上必見證據：** 小私人船有茶棕船身、茶色帆、無英文的茶葉圖徽；船靠床邊；George 一腳在床沿、一腳踏船，兩腳仍赤腳／襪子；一雙深藍運動鞋收在船內；木叉留在床邊；無 crew／鯨。  
**在場：** george  
**禁止：** Wellerman、換色換徽、船員、鯨、帶木叉登船、脫頭套。
...
**敘事功能：** 因為 Billy o' Tea 抵達，三獸並排封住沙岸；因為 George 想證明自己勇敢，所以不肯掉頭。  
**翻頁鉤子：** 三獸分開站位，準備各自給他一次警告。  
**圖上必見證據：** 船停淺灘；Horn、Beak、Goat 並排擋岸，黃眼、尖牙與利爪清楚但未攻擊；Horn 約 3×、Beak 約 2.2×、Goat 約 2.6× George；George 穿 T-rex 裝與深藍鞋站船頭，空手。  
**在場：** george, horn, beak, goat  
**禁止：** 打鬥、武器、流血、第四隻野獸、電影名、野獸與 George 等高。
...
**敘事功能：** 因為 George 通過勇氣考驗，所以三獸邀他過橋深入島心；深入後，他才明白島比沙岸大得多。  
**翻頁鉤子：** 巨大清地中央有一座空葉椅與未完成藤冠。  
**圖上必見證據：** Horn 領先走過粗藤橋，George 居中，Beak 與 Goat 護在後方；腳印全都朝島內；遠處是怪樹、月光清地、空葉椅；船留在原沙岸遠景；George 仍穿深藍鞋。  
**在場：** george, horn, beak, goat  
**禁止：** 瞬移、腳印朝海、第四隻野獸、George 獨自走失、木叉。
...
### Page 11 — Crown of Vines（WildClearing）

**敘事功能：** 因為 George 以勇氣而非武力進入清地，所以三獸選他為王；George 接受王冠，也承諾公平帶領。  
**翻頁鉤子：** Beak 敲響空木鼓，整座清地開始震動。  
**圖上必見證據：** Beak 把葉藤冠戴在 T-rex 頭套外；Horn 低頭、Goat 微笑；George 站在葉椅前；同一空木鼓在側；三獸仍皆 ≥2× George。  
**在場：** george, horn, beak, goat  
**禁止：** 冠上英文、脫頭套、寶石金冠、跪拜恐嚇、第四隻野獸。
...
**敘事功能：** 因為大家遵守 George 的規則，所以遊行安全地再玩好幾輪；月亮升高、足跡加深，讓他確實當了一陣子王。  
**翻頁鉤子：** 最後一輪停下時，George 的肚子在安靜中大聲叫。  
**圖上必見證據：** George 輪流牽 Horn、Beak、Goat 走遊行隊形；每一位結尾都友善鞠躬；地上多圈足跡、空木鼓旁散落銀色種莢、月亮升至樹頂；葉椅仍在，藤冠仍戴著。  
**在場：** george, horn, beak, goat  
**禁止：** 新野獸加入、時間突然變白天、王冠消失、危險碰撞。
...
### Page 16 — The Heavy Crown（WildClearing）
...
### Page 17 — A King Chooses Home（WildIsland）

**敘事功能：** 因為 George 明白自己想回家，所以自願辭王並把冠留島；因為三獸尊重好王的選擇，所以護送他回船。  
**翻頁鉤子：** Billy o' Tea 的茶葉帆鼓起，船頭轉向遠方暖光。  
**圖上必見證據：** 回到同一沙岸與藤橋入口；George 把藤冠交給 Horn；Beak 扶穩 Billy o' Tea、Goat 溫柔揮手；George 仍穿深藍鞋與完整 T-rex 裝；三獸比例不變。  
**在場：** george, horn, beak, goat  
**禁止：** 強留 George、追船、冠跟回家、第四隻野獸、換船。
...
### Page 18 — Homeward Light（OpenSea）
...
| WildClearing | 10–16 | 葉椅、空木鼓、銀色種莢；Horn／Beak／Goat 皆 ≥2× George | 額外野獸、武器、王冠無故消失 |

## 逐頁因果鏈

鬧著追 Sylvia → Mummy 設限 → George 被送回房而孤單 → 注意到叢林 → 發現船並主動離開 → 長航抵島 → 三獸擋岸 → George 不退而遭三次示威 → 他以穩定對視贏得信任 → 獲邀深入島心 → 被選為王 → 接受王冠而展開地面遊行 → 種莢回響帶出月下第二輪 → 碰撞促成溫柔王規 → 規則讓歡樂延續一陣子 → 安靜後感到冠重、肚餓與家中暖香 → 自願辭王並留冠 → 循鳥燈回航 → 回到仍有熱晚餐的家。

## 自查

- [x] 19 頁；其中 p7–17 為 11 頁島段，比現行 p7–10 增加 7 頁。
- [x] 每頁可說出「因為上一頁，所以這一頁」；無角色預知不該知道的資訊。
- [x] 每頁 4 句、每句有 emotion，句長維持約 8–16 個英文字。
- [x] Horn、Beak、Goat 各自多次開口；Mummy、Sylvia 開頭出場，Daddy 在熱晚餐結尾出場。
- [x] George 全程是英雄，全課 T-rex 連身裝與頭套不脫。
- [x] 馴服只靠眼神與勇氣，無打鬥、武器、刺傷或流血。
- [x] Billy o' Tea 為無 crew／無鯨的小私人茶棕船；茶葉帆徽固定。
- [x] 木叉、鞋、船、藤冠、鳥燈的出現與去向均有連續軌跡。
- [x] 無人說做夢；無禁用原句；無電影官方名；無 Mike／Nibble 或第四隻野獸。
- [x] George 自願放冠留島、回航，最後全家四人與仍熱的晚餐收束。
- [x] **GATE 1：家長 2026-09-02 選定 Sol 擴寫稿（本檔）。**
