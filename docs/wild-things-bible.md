...
狀態：2026-09-01 — 家長選定。篇章摘要見 [`wild-things-chapter.md`](wild-things-chapter.md)；逐頁分鏡見 [`wild-things-storyboard.md`](wild-things-storyboard.md)。  
畫風對齊 `lessons/assets/refs/cast/wild-things-sheet.png`。  
